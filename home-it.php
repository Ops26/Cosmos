    ...
    <div class="menu">
      <nav>
          <div class="nav-lns" id="navLinks">
              ...
              <ul>
                  <li><a href="php/project-it.php"><?php echo getMenuItems("1", "files/it/menu-items-it.txt") ?></a></li>

                  <li><a href="php/it/estudio-it.php"><?php echo getMenuItems("2", "files/it/menu-items-it.txt") ?></a>
                  </li>
                  <li><a href="php/contacto-it.php"><?php echo getMenuItems("3", "files/it/menu-items-it.txt") ?></a></li>
              </ul>
          </div>
...
<div class="footer-basic" style="margin-top: 20vh">
    <footer>
        ...
        <ul class="list-inline">
            <li class="list-inline-item"><a href="php/it/terms-of-use-it.php" target="_blank">Termini di utilizzo</a></li>
            <li class="list-inline-item"><a href="php/it/privacy-cookie-policy-it.php" target="_blank">Informativa sulla privacy e sui cookie</a></li>
            <li class="list-inline-item"><a href="php/it/credits-it.php" target="_blank">Crediti</a></li>
            <li class="list-inline-item"><a href="php/it/all-rights-reserved-it.php" target="_blank">Tutti i diritti riservati</a></li>
        </ul>
    </footer>
</div>
