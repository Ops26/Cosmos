...
<head>
    <meta charset="UTF-8">
    <title>Informativa sulla Privacy e sui Cookie</title>
    ...
    <div style="margin-top:50px;">
        <div class="fusion-column-wrapper"
            ...
            <div class="fusion-text">
                ...
                Informativa sulla Privacy e sui Cookie</strong></h3>

                <?php echo getFooterTexts('../../files/it/privacy-cookie-policy-it.txt') ?>
            </div>
        </div>
