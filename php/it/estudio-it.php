...
<head>
    ...
    <title>Studio - Cosmos Architecture</title>
...
<header>
  ...
  <div class="lingue-dropdown" style="margin-top: 3vh">
    ...
    <a href="../../home-it.php"><img style="height: 10vh; width: auto;" src="../../dashboard/icons/logo.png" class="logo"></a>
    <div class="menu">
      <nav>
          <div class="nav-lns" id="navLinks">
              <i class="fa fa-times" onclick="hideMenu()"></i>
              <ul>
                  <li><a href="../project-it.php"><?php echo getMenuItems("1", "../../files/it/menu-items-it.txt") ?></a></li>

                  <li><a href="estudio-it.php"><?php echo getMenuItems("2", "../../files/it/menu-items-it.txt") ?></a>
                  </li>
...
<section class="txt headline">
    <?php echo getEstudioText('../../files/it/estudio-it.txt') ?>

    <br><br>
    <h4>Contattateci all'indirizzo</h4>
</section>
...
<div class="footer-basic" style="margin-top: 20vh">
    <footer>
        ...
        <div style="text-align: center; margin-bottom: 29px">
            <a href="../../home.php"><img style="height: 10vh; width: auto;" src="../../dashboard/icons/logo.png"></a>
        </div>
        <ul class="list-inline">
            <li class="list-inline-item"><a href="terms-of-use-it.php" target="_blank">Termini di utilizzo</a></li>
            <li class="list-inline-item"><a href="privacy-cookie-policy-it.php" target="_blank">Informativa sulla privacy e sui cookie</a></li>
            <li class="list-inline-item"><a href="credits-it.php" target="_blank">Crediti</a></li>
            <li class="list-inline-item"><a href="all-rights-reserved-it.php" target="_blank">Tutti i diritti riservati</a></li>
        </ul>
    </footer>
</div>
</body>
