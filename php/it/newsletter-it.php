    ...
    <nav>
        <div class="nav-lns" id="navLinks">
            ...
            <ul>
                ...
                <li>
                    <a href="newsletter-it.php"><?php echo getMenuItems("2", "../../files/menu-items.txt") ?></a>
                </li>
                <li>
                    <a href="estudio-it.php"><?php echo getMenuItems("3", "../../files/menu-items.txt") ?></a>
                </li>
                <li>
...
<div class="testo-col1">
    <h4>
        BLOG<br>
        <?php echo getNewsletterDate("../../files/it/newsletter-date-it.txt") ?>
    </h4></div>

<div class="testo-col">
    <p>
        <?php echo getNewsletterText("../../files/it/newsletter-text-it.txt") ?>
    </p>
</div>
...
<div class="footer-basic">
    <footer>
        ...
        <ul class="list-inline">
            <li class="list-inline-item"><a href="terms-of-use-it.php" target="_blank">Terms of use</a></li>
            <li class="list-inline-item"><a href="privacy-cookie-policy-it.php" target="_blank">Privacy & Cookies Policy</a></li>
            <li class="list-inline-item"><a href="credits-it.php" target="_blank">Credits</a></li>
            <li class="list-inline-item"><a href="all-rights-reserved-it.php" target="_blank">All Rights Reserved</a></li>
        </ul>
    </footer>
</div>
</body>
