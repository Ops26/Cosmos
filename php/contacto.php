...
<head>
    ...
    <title>Contacts - Cosmos Architecture</title>
...
<section class="prova">
    <div class="container">
        ...
        <form onsubmit="sendEmail(); reset(); return false;">
            <p style="font-size: 18px; text-align: center; font-size: 18px; font-weight: 500;">Ask us a question</p>
            <input class="contactoInput" type="text" id="name" placeholder="Your name" required>
            <input class="contactoInput" type="email" id="email" placeholder="Email" required>
            <textarea class="contactoInput" name="message" id="message" placeholder="How can we help you?"
                      rows="4"></textarea>
    ...
    <div style="text-align: center">
        <p><?php echo getContactoInformation("../files/contacto-information.txt") ?></p>
    </div>
...
<div class="txt_map">
  ...
  <h1>Offices around the World</h1>
