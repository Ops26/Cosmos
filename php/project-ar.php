...
<html xmlns="https://cosmosarchitecture.com/XHTML">
    <head>
        ...
        <title>المشاريع - Cosmos Architecture</title>
  ...
  <div class="menu">
    <nav>
        <div class="nav-lns" id="navLinks">
            ...
            <ul>
                <li><a href="#"><?php echo getMenuItems("1", "../files/ar/menu-items-ar.txt") ?></a></li>

                <li><a href="ar/estudio-ar.php"><?php echo getMenuItems("2", "../files/ar/menu-items-ar.txt") ?></a>
                </li>
                <li><a href="contacto-ar.php"><?php echo getMenuItems("3", "../files/ar/menu-items-ar.txt") ?></a></li>
            </ul>
        </div>
        ...
        <nav>
            <div id="myBtnContainer">
                <button class="btn active" onclick="filterSelection('all')"> الجميع</button>
                <button class="btn" onclick="filterSelection('architecture')"> هندسة عامة</button>
                <button class="btn" onclick="filterSelection('interior')">تصميم داخلي</button>
                <button class="btn" onclick="filterSelection('urbanism')"> العمران</button>
