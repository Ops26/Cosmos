...
<head>
    ...
    <title>Contatti - Cosmos Architecture</title>
  ...
  <section class="head" style="margin-top: 2vh;">
    ...
    <div class="lingue">
      <ul >
                    ...
                    <li><a href="contacto-it.php"  ><!-- <img alt
...
<section>
    <div class="container">
        ...
        <form onsubmit="sendEmail(); reset(); return false;">
            <p style="font-size: 18px; text-align: center; font-size: 18px; font-weight: 500;">Facci una domanda</p>
            <input class="contactoInput" type="text" id="name" placeholder="Nome" required>
            <input class="contactoInput" type="email" id="email" placeholder="Email" required>
            <textarea class="contactoInput" name="message" id="message" placeholder="Come possiamo aiutarti?"
                      rows="4"></textarea>
    ...
    <div style="text-align: center">
        <p><?php echo getContactoInformation("../files/it/contacto-information-it.txt") ?></p>
    </div>
...
<div class="footer-basic" style="margin-top: 20vh">
    <footer>
        ...
        <ul class="list-inline">
            <li class="list-inline-item"><a href="it/terms-of-use-it.php" target="_blank">Termini di utilizzo</a></li>
            <li class="list-inline-item"><a href="it/privacy-cookie-policy-it.php" target="_blank">Informativa sulla privacy e sui cookie</a></li>
            <li class="list-inline-item"><a href="it/credits-it.php" target="_blank">Crediti</a></li>
            <li class="list-inline-item"><a href="it/all-rights-reserved-it.php" target="_blank">Tutti i diritti riservati</a></li>
        </ul>
    </footer>
</div>
