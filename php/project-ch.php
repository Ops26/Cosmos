...
<html xmlns="https://cosmosarchitecture.com/XHTML">
    <head>
        ...
        <title>項目 - Cosmos Architecture</title>
  ...
  <div class="menu">
    <nav>
        <div class="nav-lns" id="navLinks">
            ...
            <ul>
                <li><a href="#"><?php echo getMenuItems("1", "../files/ch/menu-items-ch.txt") ?></a></li>
        ...
        <nav>
            <div id="myBtnContainer">
                ...
                <button class="btn" onclick="filterSelection('architecture')"> 建築學</button>
                <button class="btn" onclick="filterSelection('interior')">室內設計</button>
                <button class="btn" onclick="filterSelection('urbanism')"> 都市主義</button>
