...
<head>
    ...
    <title>جهات الاتصال - Cosmos Architecture</title>
    <!--    <link rel="stylesheet" href="">-->

    <link rel="stylesheet" href="../css/mobile.css">
    <link rel="stylesheet" href="../images/img-test/style.css">

    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com">
    <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css">

          <link href="Map/dist/svgMap.css" rel="stylesheet">
<script src="Map/dist/svgMap.js"></script>
    <!--    <link rel="stylesheet" href="../css/style.css">-->
    <link rel="stylesheet" href="../css/contacto.css">
    <link rel="stylesheet" href="../css/footer.css">
    <link real="stylesheet" href="../css/header.css">
...
<?php include '../functions/getSocialMediaLinks.php'; ?>
  ...
  <section class="head" style="margin-top: 2vh;">
    <div class="social">
  ...
  <div class="menu">
    <nav>
        <div class="nav-lns" id="navLinks">
            ...
            <ul>
                <li><a href="project-ar.php"><?php echo getMenuItems("1", "../files/ar/menu-items-ar.txt") ?></a></li>
...
<section>
    <div class="container">
        ...
        <form onsubmit="sendEmail(); reset(); return false;">
            <p style="font-size: 18px; text-align: center; font-size: 18px; font-weight: 500;">اسألنا سؤالا</p>
            <input class="contactoInput" type="text" id="name" placeholder="اسم" required>
            <input class="contactoInput" type="email" id="email" placeholder="البريد الإلكتروني" required>
            <textarea class="contactoInput" name="message" id="message" placeholder="كيف يمكننا مساعدتك؟"
                      rows="4"></textarea>
    ...
    <div style="text-align: center">
        <p><?php echo getContactoInformation("../files/ar/contacto-information-ar.txt") ?></p>
    </div>
...
<div class="txt_map">
  ...
  <h1>مكاتب في جميع أنحاء العالم</h1>
...
<a id="open2">
   ...
   <path class="Ecuador" d="M559 502.8l0.8 4.9-1.7 4.1-6.1 6.8-6.7 2.5-3.4 5.6-0.9 4.3-3.1 2.7-2.5-3.3-2.3-0.7-2.3 0.5-0.3-2.3 1.6-1.5-0.7-2.7 2.9-4.8-1.3-2.8-2.1 3-3.5-2.9 1.1-1.8-1-5.8 2-1 1-4 2.1-4.1-0.3-2.6 3.1-1.4 3.9-2.5 5.6 3.6 1.1-0.1 1.4 2.8 4.8 0.9 1.6-1 2.8 2.1 2.4 1.5z" id="EC" name="Ecuador">
   </path>
   ...
   <path class="Eritrea" d="M1228.9 420.3l-1.7 1.6-2.4-0.6-2-2.1-2.5-3.7-2.6-2.1-1.5-2.2-5-2.6-3.9-0.1-1.4-1.3-3.2 1.5-3.6-2.9-1.5 4.8-6.6-1.4-0.7-2.5 2-9.5 0.3-4.2 1.7-2 4-1.1 2.7-3.6 3.6 7.4 1.9 5.9 3.2 3.1 8 6.1 3.3 3.6 3.2 3.8 1.8 2.2 2.9 1.9z" id="ER" name="Eritrea">
   </path>
...
<a id="open">
   <path class="Spain" d="M976.6 223.4l2 2.4 9.5 2.9 1.9-1.4 5.8 2.9 5.9-0.8 0.4 3.7-4.9 4.2-6.6 1.4-0.5 2.1-3.2 3.5-2 5.2 2 3.7-3 2.8-1.2 4.2-4 1.3-3.7 4.9-6.8 0.1-5-0.1-3.4 2.2-2.1 2.4-2.6-0.5-1.9-2.2-1.4-3.6-4.9-1-0.4-2.2 2-2.4 0.8-1.7-1.8-1.9 1.6-4.2-2-3.8 2.3-0.5 0.3-3.1 0.8-0.9 0.3-5 2.4-1.7-1.3-3.2-3.1-0.2-0.9 0.8-3 0-1.2-3.1-2.2 0.9-1.9 1.6 0.5-4.5-2-2.7 7.4-4.6 6.2 1.1 6.9 0 5.4 1.1 4.3-0.4 8.3 0.3z" id="ES" name="Spain">
   </path>
</a>
...
<script>
    function sendEmail() {
        Email.send({
            ...
            Username: "gdsddsf",
            Password: "Cosmos19.!",
            To: 'info@cosmosarchitecture.com',
...
<div class="footer-basic" style="margin-top: 20vh">
    <footer>
        ...
        <ul class="list-inline" dir="rtl">
            <li class="list-inline-item" ><a href="ar/terms-of-use-ar.php" target="_blank" dir="rtl">شروط الاستخدام</a></li>
            <li class="list-inline-item"><a href="ar/privacy-cookie-policy-ar.php" target="_blank">سياسة الخصوصية وملفات تعريف الارتباط</a></li>
            <li class="list-inline-item"><a href="ar/credits-ar.php" target="_blank">الاعتمادات</a></li>
            <li class="list-inline-item"><a href="ar/all-rights-reserved-ar.php" target="_blank">كل الحقوق محفوظة</a></li>
        </ul>
    </footer>
</div>
