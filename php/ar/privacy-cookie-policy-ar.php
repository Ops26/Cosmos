...
<head>
    <meta charset="UTF-8">
    <title>سياسة ملفات تعريف الارتباط الخصوصية</title>
    ...
    <div style="margin-top:50px;">
        <div class="fusion-column-wrapper"
            ...
            <div class="fusion-text">
                <h3 style="text-align: center; --fontSize:20; line-height: 1.3; --minFontSize:20;" dir="rtl"><strong>
                سياسة ملفات تعريف الارتباط الخصوصية</strong></h3>

                <div class="direction" dir="rtl">
                    <?php echo getFooterTexts('../../files/ar/privacy-cookie-policy-ar.txt') ?>    
                </div>
            </div>
        </div>
