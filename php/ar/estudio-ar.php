...
<header>
  ...
  <div class="lingue-dropdown" style="margin-top: 3vh">
    ...
    <a href="../../home-ar.php"><img style="height: 10vh; width: auto;" src="../../dashboard/icons/logo.png"
                                                                                              class="logo"></a>
    <div class="menu">
      <nav>
          <div class="nav-lns" id="navLinks">
              ...
              <ul>
                  <li><a lang="ar" dir="rtl" href="../project-ar.php"><?php echo getMenuItems("1", "../../files/ar/menu-items-ar.txt") ?></a></li>

                  <li><a lang="ar" dir="rtl" href="../ar/estudio-ar.php"><?php echo getMenuItems("2", "../../files/ar/menu-items-ar.txt") ?></a>
                  </li>
                  <li><a lang="ar" dir="rtl" href="../contacto-ar.php"><?php echo getMenuItems("3", "../../files/ar/menu-items-ar.txt") ?></a></li>
              </ul>
          </div>
...
<div class="footer-basic" style="margin-top: 20vh">
    <footer>
        ...
        <ul class="list-inline" dir="rtl">
            <li class="list-inline-item" ><a href="terms-of-use-ar.php" target="_blank" dir="rtl">شروط الاستخدام</a></li>
            <li class="list-inline-item"><a href="privacy-cookie-policy-ar.php" target="_blank">سياسة الخصوصية وملفات تعريف الارتباط</a></li>
            <li class="list-inline-item"><a href="credits-ar.php" target="_blank">الاعتمادات</a></li>
            <li class="list-inline-item"><a href="all-rights-reserved-ar.php" target="_blank">كل الحقوق محفوظة</a></li>
        </ul>
    </footer>
</div>
