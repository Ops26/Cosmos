...
<head>
    ...
    <title>聯繫人 - Cosmos Architecture</title>
...
<section>
    <div class="container">
        ...
        <form onsubmit="sendEmail(); reset(); return false;">
            <p style="font-size: 18px; text-align: center; font-size: 18px; font-weight: 500;">問我們一個問題</p>
            <input class="contactoInput" type="text" id="name" placeholder="姓名" required>
            <input class="contactoInput" type="email" id="email" placeholder="電子郵件" required>
            <textarea class="contactoInput" name="message" id="message" placeholder="我們該怎樣幫助你？"
                      rows="4"></textarea>
    ...
    <div style="text-align: center">
        <p><?php echo getContactoInformation("../files/ch/contacto-information-ch.txt") ?></p>
    </div>
...
<div class="footer-basic" style="margin-top: 20vh">
    <footer>
        ...
        <ul class="list-inline">
            <li class="list-inline-item"><a href="ch/terms-of-use-ch.php" target="_blank">使用條款</a></li>
            <li class="list-inline-item"><a href="ch/privacy-cookie-policy-ch.php" target="_blank">隱私和 Cookie 政策</a></li>
            <li class="list-inline-item"><a href="ch/credits-ch.php" target="_blank">製作人員</a></li>
            <li class="list-inline-item"><a href="ch/all-rights-reserved-ch.php" target="_blank">版權所有</a></li>
        </ul>
    </footer>
</div>
