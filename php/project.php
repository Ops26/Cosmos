...
<html xmlns="https://cosmosarchitecture.com/XHTML">
    <head>
        ...
        <title>Projects - Cosmos Architecture</title>
    ...
    <nav>
        ...
        <nav>
            <div id="myBtnContainer">
                ...
                <button class="btn" onclick="filterSelection('interior')"> Interior Design</button>
                <button class="btn" onclick="filterSelection('urbanism')"> Urbanism</button>
