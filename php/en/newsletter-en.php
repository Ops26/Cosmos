...
<header>
    <div class="socinsta">
        ...
        <ul>
            ...
            <li><a href='<?php echo getSocialMediaLink("facebook", "../../files/social-media-links.txt"); ?>' target="_blank"><img alt
                                                                                                                   style="width:28px; height: 20px; margin-top: 6px; margin-left: 0px;"
                                                                                                                   src="../../dashboard/icons/facebook-logo.png"></a>
            </li>
            <li><a href='<?php echo getSocialMediaLink("linkedin", "../../files/social-media-links.txt"); ?>' target="
              "><img alt
            ...
            <div class="band">
                <ul>
                    ...
                    <li><a href="../ar/newsletter-ar.php"><img alt
                                                               style="width: 15px; height: 15px; margin-top: 6px; margin-left: 0px;"
    ...
    <nav>
        <div class="nav-lns" id="navLinks">
            ...
            <ul>
                ...
                <li>
                    <a href="newsletter-en.php"><?php echo getMenuItems("2", "../../files/menu-items.txt") ?></a>
                </li>
                <li>
                    <a href="estudio-en.php"><?php echo getMenuItems("3", "../../files/menu-items.txt") ?></a>
                </li>
                <li>
...
<div class="testo-col1">
    <h4>
        BLOG<br>
        <?php echo getNewsletterDate("../../files/newsletter-date.txt") ?>
    </h4></div>

<div class="testo-col">
    <p>
        <?php echo getNewsletterText("../../files/en/newsletter-text-en.txt") ?>
    </p>
</div>
