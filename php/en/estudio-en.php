...
<head>
    ...
    <title>Office - Cosmos Architecture</title>
      ...
      <nav>
          <div class="nav-lns" id="navLinks">
              ...
              <ul>
                  ...
                  <li><a href="../en/estudio-en.php"><?php echo getMenuItems("2", "../../files/menu-items.txt") ?></a>
                  </li>
...
<div class="hero">
  ...
  <!--   <div class="video">
      <iframe  src="https://www.youtube.com/embed/cTfsHjCjGkY?&autoplay=1&mute=1&playsinline=1&controls=0&playlist=cTfsHjCjGkY&loop=1" ></iframe>
    </div> -->
...
include '../../functions/Add-member.php';

?>

<section class="txt headline">

    <?php echo getEstudioText('../../files/en/estudio-en.txt') ?>
...
<div class="footer-basic" style="margin-top: 20vh">
    <footer>
        ...
        <ul class="list-inline">
            <li class="list-inline-item"><a href="terms-of-use-en.php" target="_blank">Terms of use</a></li>
            <li class="list-inline-item"><a href="privacy-cookie-policy-en.php" target="_blank">Privacy & Cookies Policy</a></li>
            <li class="list-inline-item"><a href="credits-en.php" target="_blank">Credits</a></li>
            <li class="list-inline-item"><a href="all-rights-reserved-en.php" target="_blank">All Rights Reserved</a></li>
        </ul>
    </footer>
</div>
...
<!-- <div class="footer-basic" style="margin-top: 0 !important">
    <footer>
        ...
        <div style="text-align: center; margin-bottom: 29px">
            <a href="../index.php"><img src="../dashboard/icons/logo.svg" alt="company logo"></a>
        </div>
        <ul class="list-inline">
            <li class="list-inline-item"><a href="terms-of-use-en.php">Terms of use</a></li>
            <li class="list-inline-item"><a href="privacy-cookie-policy-en.php">Privacy & Cookies Policy</a></li>
            <li class="list-inline-item"><a href="credits-en.php">Credits</a></li>
            <li class="list-inline-item"><a href="all-rights-reserved-en.php">All Rights Reserved</a></li>
        </ul>
    </footer>
</div> -->
