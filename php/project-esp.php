...
<html xmlns="https://cosmosarchitecture.com/XHTML">
    <head>
        ...
        <title>Proyectos - Cosmos Architecture</title>
  ...
  <div class="menu">
    <nav>
        <div class="nav-lns" id="navLinks">
            ...
            <ul>
                <li><a href="#"><?php echo getMenuItems("1", "../files/esp/menu-items-esp.txt") ?></a></li>

                <li><a href="esp/estudio-esp.php"><?php echo getMenuItems("2", "../files/esp/menu-items-esp.txt") ?></a>
                </li>
        ...
        <nav>
            <div id="myBtnContainer">
                ...
                <button class="btn" onclick="filterSelection('architecture')"> Arquitectura</button>
                <button class="btn" onclick="filterSelection('interior')"> Diseño de interiores</button>
