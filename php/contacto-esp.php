...
<head>
    ...
    <title>Contactos - Cosmos Architecture</title>
  ...
  <section class="head" style="margin-top: 2vh;">
    ...
    <div class="lingue">
      <ul >
                    ...
                    <li><a href="contacto-esp.php" ><!-- <img alt
                                                              style="width:15px; height: 15px; margin-top: 6px; margin-left: 0px;"
...
<section>
    <div class="container">
        ...
        <form onsubmit="sendEmail(); reset(); return false;">
            <p style="font-size: 18px; text-align: center; font-size: 18px; font-weight: 500;">Háganos una pregunta</p>
            <input class="contactoInput" type="text" id="name" placeholder="Nombre" required>
            <input class="contactoInput" type="email" id="email" placeholder="Email" required>
            <textarea class="contactoInput" name="message" id="message" placeholder="Como podemos ayudarte?"
                      rows="4"></textarea>
    ...
    <div style="text-align: center">
        <p><?php echo getContactoInformation("../files/esp/contacto-information-esp.txt") ?></p>
    </div>
...
<div class="txt_map">
  ...
  <h1>Oficinas en todo el Mundo</h1>
...
<div class="footer-basic" style="margin-top: 20vh">
    <footer>
        ...
        <ul class="list-inline">
            <li class="list-inline-item"><a href="esp/terms-of-use-esp.php" target="_blank">Condiciones de uso</a></li>
            <li class="list-inline-item"><a href="esp/privacy-cookie-policy-esp.php" target="_blank">Política de privacidad y cookies</a></li>
            <li class="list-inline-item"><a href="esp/credits-esp.php" target="_blank">Créditos</a></li>
            <li class="list-inline-item"><a href="esp/all-rights-reserved-esp.php" target="_blank">Reservados todos los derechos</a></li>
        </ul>
    </footer>
</div>
