...
<head>
    ...
    <title>辦公室 - Cosmos Architecture</title>
...
<header>
  ...
  <div class="lingue-dropdown" style="margin-top: 3vh">
    ...
    <a href="../../home-ch.php"><img style="height: 10vh; width: auto;" src="../../dashboard/icons/logo.png"
                                                                                              class="logo"></a>
    <div class="menu">
      <nav>
          <div class="nav-lns" id="navLinks">
              ...
              <ul>
                  <li><a href="../project-ch.php"><?php echo getMenuItems("1", "../../files/ch/menu-items-ch.txt") ?></a></li>

                  <li><a href="../ch/estudio-ch.php"><?php echo getMenuItems("2", "../../files/ch/menu-items-ch.txt") ?></a>
                  </li>
                  <li><a href="../contacto-ch.php"><?php echo getMenuItems("3", "../../files/ch/menu-items-ch.txt") ?></a></li>
              </ul>
          </div>
...
<section class="txt headline">
    ...
    <?php echo getEstudioText('../../files/ch/estudio-ch.txt') ?>
...
<div class="footer-basic" style="margin-top: 20vh">
    <footer>
        ...
        <ul class="list-inline">
            <li class="list-inline-item"><a href="terms-of-use-ch.php" target="_blank">使用條款</a></li>
            <li class="list-inline-item"><a href="privacy-cookie-policy-ch.php" target="_blank">隱私和 Cookie 政策</a></li>
            <li class="list-inline-item"><a href="credits-ch.php" target="_blank">製作人員</a></li>
            <li class="list-inline-item"><a href="all-rights-reserved-ch.php" target="_blank">版權所有</a></li>
        </ul>
    </footer>
</div>
