    ...
    <nav>
        <div class="nav-lns" id="navLinks">
            ...
            <ul>
                ...
                <li>
                    <a href="newsletter-ch.php"><?php echo getMenuItems("2", "../../files/menu-items.txt") ?></a>
                </li>
                <li>
                    <a href="estudio-ch.php"><?php echo getMenuItems("3", "../../files/menu-items.txt") ?></a>
                </li>
                <li>
...
<div class="testo-col1">
    <h4>
        BLOG<br>
        <?php echo getNewsletterDate("../../files/ch/newsletter-date-ch.txt") ?>
    </h4></div>

<div class="testo-col">
    <p>
        <?php echo getNewsletterText("../../files/ch/newsletter-text-ch.txt") ?>
    </p>
</div>
