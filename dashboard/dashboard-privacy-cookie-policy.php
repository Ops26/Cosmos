...
<section class="home-section">
    <div class="text">Dashboard - Privacy Cookie Policy</div>
    ...
    <textarea id="textarea-en" class="terms-of-use-textarea"
              placeholder="add some text here (Terms Of Use)"><?php echo getFooterTexts('../files/en/privacy-cookie-policy-en.txt') ?></textarea>
    <BR>

    <button class="saveButton" onclick="updateText('en')">
        Save
    </button>
    <a href="../php/en/privacy-cookie-policy-en.php" class="openPageButton">Open Page</a>
    ...
    <textarea id="textarea-esp" class="terms-of-use-textarea"
              placeholder="add some text here (Terms Of Use)"><?php echo getFooterTexts('../files/esp/privacy-cookie-policy-esp.txt') ?></textarea>
    <BR>

    <button class="saveButton" onclick="updateText('esp')">
        Save
    </button>
    <a href="../php/esp/privacy-cookie-policy-esp.php" class="openPageButton">Open Page</a>
    ...
    <textarea id="textarea-it" class="terms-of-use-textarea"
              placeholder="add some text here (Terms Of Use)"><?php echo getFooterTexts('../files/it/privacy-cookie-policy-it.txt') ?></textarea>
    <BR>

    <button class="saveButton" onclick="updateText('it')">
        Save
    </button>
    <a href="../php/it/privacy-cookie-policy-it.php" class="openPageButton">Open Page</a>
    ...
    <script>
        ...
        function updateText(language) {
            ...
            $.ajax({
                ...
                type: "POST",
                data: {functionCall: "update", text: myContent, selector: "privacy-cookie-policy", language: language},
