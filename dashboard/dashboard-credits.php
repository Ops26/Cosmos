...
<section class="home-section">
    <div class="text">Dashboard - Credits</div>
    ...
    <textarea id="textarea-en" class="terms-of-use-textarea"
              placeholder="add some text here (Terms Of Use)"><?php echo getFooterTexts('../files/en/credits-en.txt') ?></textarea>
    <BR>

    <button class="saveButton" onclick="updateText('en')">
        Save
    </button>
    <a href="../php/en/credits-en.php" class="openPageButton">Open Page</a>
    ...
    <textarea id="textarea-esp" class="terms-of-use-textarea"
              placeholder="add some text here (Terms Of Use)"><?php echo getFooterTexts('../files/esp/credits-esp.txt') ?></textarea>
    <BR>

    <button class="saveButton" onclick="updateText('esp')">
        Save
    </button>
    <a href="../php/esp/credits-esp.php" class="openPageButton">Open Page</a>
    ...
    <textarea id="textarea-it" class="terms-of-use-textarea"
              placeholder="add some text here (Terms Of Use)"><?php echo getFooterTexts('../files/it/credits-it.txt') ?></textarea>
    <BR>

    <button class="saveButton" onclick="updateText('it')">
        Save
    </button>
    <a href="../php/it/credits-it.php" class="openPageButton">Open Page</a>
    ...
    <script>
        ...
        function updateText(language) {
            ...
            $.ajax({
                ...
                type: "POST",
                data: {functionCall: "update", text: myContent, selector: "credits", language: language},
