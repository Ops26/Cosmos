...
<section class="home-section">
    <div class="text">Dashboard - Terms Of Use</div>
    ...
    <textarea id="textarea-en" class="terms-of-use-textarea"
              placeholder="add some text here (Terms Of Use)"><?php echo getFooterTexts('../files/en/terms-of-use-en.txt') ?></textarea>
    <BR>

    <button class="saveButton" onclick="updateText('en')">
        Save
    </button>
    <a href="../php/en/terms-of-use-en.php" class="openPageButton">Open Page</a>
    ...
    <textarea id="textarea-esp" class="terms-of-use-textarea"
              placeholder="add some text here (Terms Of Use)"><?php echo getFooterTexts('../files/esp/terms-of-use-esp.txt') ?></textarea>
    <BR>

    <button class="saveButton" onclick="updateText('esp')">
        Save
    </button>
    <a href="../php/esp/terms-of-use-esp.php" class="openPageButton">Open Page</a>
    ...
    <textarea id="textarea-it" class="terms-of-use-textarea"
              placeholder="add some text here (Terms Of Use)"><?php echo getFooterTexts('../files/it/terms-of-use-it.txt') ?></textarea>
    <BR>

    <button class="saveButton" onclick="updateText('it')">
        Save
    </button>
    <a href="../php/it/terms-of-use-it.php" class="openPageButton">Open Page</a>
    ...
    <script>
        ...
        function updateText(language) {
            ...
            $.ajax({
                ...
                type: "POST",
                data: {functionCall: "update", text: myContent, selector: "terms-of-use", language: language},
