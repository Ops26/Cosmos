    ...
    <div class="menu">
      <nav>
          <div class="nav-lns" id="navLinks">
              ...
              <ul>
                  <li><a href="php/project-ar.php"><?php echo getMenuItems("1", "files/ar/menu-items-ar.txt") ?></a></li>

                  <li><a href="php/ar/estudio-ar.php"><?php echo getMenuItems("2", "files/ar/menu-items-ar.txt") ?></a>
                  </li>
                  <li><a href="php/contacto-ar.php"><?php echo getMenuItems("3", "files/ar/menu-items-ar.txt") ?></a></li>
              </ul>
          </div>
    ...
    <section class="sec"
        ...
        <nav>
            <div class="nav-progetto1">
                <ul>
                    <li><a lang="ar" dir="rtl" href="https://<?php echo str_replace('ÜÜ', '/', $p['filename']) ?>"
                           class="hero-btn">مشروع</a></li>
                </ul>
            </div>
        </nav>
        </section><?php
...
<div class="footer-basic" style="margin-top: 20vh">
    <footer>
        ...
        <ul class="list-inline" dir="rtl">
            <li class="list-inline-item" ><a href="php/ar/terms-of-use-ar.php" target="_blank" dir="rtl">شروط الاستخدام</a></li>
            <li class="list-inline-item"><a href="php/ar/privacy-cookie-policy-ar.php" target="_blank">سياسة الخصوصية وملفات تعريف الارتباط</a></li>
            <li class="list-inline-item"><a href="php/ar/credits-ar.php" target="_blank">الاعتمادات</a></li>
            <li class="list-inline-item"><a href="php/ar/all-rights-reserved-ar.php" target="_blank">كل الحقوق محفوظة</a></li>
        </ul>
    </footer>
</div>
