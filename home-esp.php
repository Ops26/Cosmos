    ...
    <div class="menu">
      <nav>
          <div class="nav-lns" id="navLinks">
              ...
              <ul>
                  <li><a href="php/project-esp.php"><?php echo getMenuItems("1", "files/esp/menu-items-esp.txt") ?></a></li>

                  <li><a href="php/esp/estudio-esp.php"><?php echo getMenuItems("2", "files/esp/menu-items-esp.txt") ?></a>
                  </li>
                  <li><a href="php/contacto-esp.php"><?php echo getMenuItems("3", "files/esp/menu-items-esp.txt") ?></a></li>
              </ul>
          </div>
...
<div class="footer-basic" style="margin-top: 20vh">
    <footer>
        ...
        <ul class="list-inline">
            <li class="list-inline-item"><a href="php/esp/terms-of-use-esp.php" target="_blank">Condiciones de uso</a></li>
            <li class="list-inline-item"><a href="php/esp/privacy-cookie-policy-esp.php" target="_blank">Política de privacidad y cookies</a></li>
            <li class="list-inline-item"><a href="php/esp/credits-esp.php" target="_blank">Créditos</a></li>
            <li class="list-inline-item"><a href="php/esp/all-rights-reserved-esp.php" target="_blank">Reservados todos los derechos</a></li>
        </ul>
    </footer>
</div>
